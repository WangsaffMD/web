function getValue() {
    ...
    */
    //console.log(test);
    const submit = `https://wa.me/6285697102235?text=Nama : ${nama}%0aUmur : ${umur}%0aAsal : ${kota}%0aWinrate : ${wr}%0aRank Tertinggi : ${rank}%0aRank Saat Ini : ${rr}%0aRole : ${role}%0aID ML : ${id}`;
